...
# SAVE_DIR = (Path(__file__).resolve().parent / "checkpoints_gemma_original")
...
class CrossCoder(nn.Module):
    ...
    def create_save_dir(self):
        ...
        base_dir = (Path(__file__).resolve().parent / f"checkpoints_{self.cfg['method']}_{self.cfg['model_name']}/{self.cfg['hook_point'].replace('.','_')}")
